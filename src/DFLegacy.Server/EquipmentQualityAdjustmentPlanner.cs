...
public static class EquipmentQuality
{
    ...
    public static uint RollSeed(IDropRandomSource random)
    {
        ...
        // a managed PRNG. Production callers pass GameRandomSource.Shared, so
        // the value is sampled from RDSEED when the native bridge is available
        // and otherwise follows the documented OS-CSPRNG/PRNG fallback chain.
